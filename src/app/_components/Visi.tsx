...
export default function Visi() {
    return (
        <>
        <div className="relative bg-secondary w-full mt-31" id="benefit">
            ...
            <Image
                ...
                width={380}
                height={280}
                className="absolute mt-[22.5px] drop-shadow-[0_3px_90px_rgba(255,255,255,0.73)] right-0 z-[1]"
            />
            <Image
                ...
                width={110}
                height={110}
                className="absolute mt-[118.5px] drop-shadow-[0_3px_90px_rgba(255,255,255,0.73)] right-[550px] z-[1]"
            />
            <Image
